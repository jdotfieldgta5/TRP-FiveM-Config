...
config = {
	...
	-- jail addon
	removeWeaponsIfArrested = true, -- remove Weapons when Player get arrested
	-- jail addon end
...
txt = {
	fr = {
		...
		-- jail addon
		menu_put_in_jail_title = "Mettre en prison",
		menu_arrest_title = "Arrêter",
		menu_custom_amount_jail_title = "Autre montant en seconds",
