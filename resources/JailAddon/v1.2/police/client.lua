...
AddEventHandler('jail:teleportPlayer', function(amount)
	if(isHandCuffed == true) then
		...
		TriggerEvent('chatMessage', txt[config.lang]["jail_notification_title"], {0,0,0}, txt[config.lang]["jail_arrest_notification_part_1"] .. amount .. txt[config.lang]["jail_arrest_notification_part_2"])
		...
		Citizen.CreateThread(function()
			...
			-- Remove Weapons
			if (config.removeWeaponsIfArrested == true) then
				RemoveAllPedWeapons(GetPlayerPed(-1))
				TriggerEvent('chatMessage', txt[config.lang]["jail_notification_title"], {0,0,0}, txt[config.lang]["jail_weapons_removed"])
			end
