...
cfg.emotes = {
  ...
  ["Garden"] = {false, {task="WORLD_HUMAN_GARDENER_PLANT"}, false},
  ...
  ["Feminine Smoke"] = {false, {task="WORLD_HUMAN_PROSTITUTE_HIGH_CLASS"}, false},
  ["Hoe"] = {false, {task="WORLD_HUMAN_PROSTITUTE_LOW_CLASS"}, false},
  ...
  ["Play on Phone"] = {false, {task="WORLD_HUMAN_STAND_MOBILE"}, false},
  ["Dig it"] = {false, {task="WORLD_HUMAN_STRIP_WATCH_STAND"}, false},
  ["Sunbathe Back"] = {false, {task="WORLD_HUMAN_SUNBATHE_BACK"}, false},
  ["Sunbath Front"] = {false, {task="WORLD_HUMAN_SUNBATHE"}, false},
