...
cfg.services = {
  ["police"] = {
    ...
    answer_notify = "~b~The police are on their way!"
  },
  ["emergency"] = {
    blipid = 153,
    blipcolor = 1,
    ...
    answer_notify = "~b~Emergency services are on their way!"
  },
  ["taxi"] = {
    blipid = 198,
    blipcolor = 5,
  ...
  ["repair"] = {
    ...
    notify = "~y~You called for a repair.",
    answer_notify = "~y~Someone is on their way to repair your vehicle!"
  }
}
